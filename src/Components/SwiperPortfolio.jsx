      ...
      >
        <SwiperSlide>
            <div className="BoxPortfolio">
                ...
                <div><p><span>TEST PAGE:</span> I made this project to practice <br />  html and css . {`It's`} simple but fun.</p></div>
        ...
        <SwiperSlide>
            <div className="BoxPortfolio">
                ...
                <div><p><span>DATING APP: </span> Let words transform your day. <br /> Explore our phrases page and discover the magic of words that inspire, <br /> motivate and uplift your spirit.</p></div>
        ...
        <SwiperSlide>
            <div className="BoxPortfolio">
                ...
                <div><p><span>RICK AND MORTY: </span>Immerse yourself in the cosmic mayhem of Rick and Morty on our website. <br /> Discover exclusive content and unleash your interdimensional side!</p></div>
        ...
        <SwiperSlide>
            <div className="BoxPortfolio">
                ...
                <div><p><span>MAKEUP WEBSITE: </span>Unleash your creativity and transform your appearance with our makeup website. <br /> Discover trends, tutorials and essential products.</p></div>
        ...
        <SwiperSlide>
            <div className="BoxPortfolio">
                ...
                <div><p><span>APP POKEDEX: </span>Are you ready to be a Pokémon Master? Discover our website and immerse yourself <br /> in the fascinating world of Pokémon battles, trades and adventures.</p></div>
        ...
        <SwiperSlide>
            <div className="BoxPortfolio">
                ...
                <div><p><span>WEATHER APP: </span>Discover how our weather app will keep you informed and prepared for any weather condition. Try it right now.</p></div>
        ...
        <SwiperSlide>
            <div className="BoxPortfolio">
                ...
                <div><p><span>CPP WEBSITE: </span>Learn the programming language c++.</p></div>
        ...
        <SwiperSlide>
            <div className="BoxPortfolio">
                ...
                <div><p><span>ESPAM UNIVERSITY: </span>Replicate my university website. This is the original site → <a className="styleAncore" href="http://www.espam.edu.ec/inicio.aspx" target="_blank" rel="noopener noreferrer">Espam Mfl</a></p></div>
