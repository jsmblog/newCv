...
const SwiperPortfolio = ({mUp1 , mUp2 , mUp3 , mUp4 , mUp5 , mUp6 , mUp7 , mUp8 , t}) => {
  return (
    <>
      <Swiper
        spaceBetween={30}
      ...
      >
        ...
        <SwiperSlide>
            <div className="BoxPortfolio">
                ...
                <div className="paragraphPort" ><p><span>DATING APP: </span> {t("title.Let-words-transform-your-day.")} <br /> {t("title.Explore-our-phrases-page-and-discover-the-magic-of-words-that-inspire-,")} <br /> {t("title.motivate-and-uplift-your-spirit.")}</p></div>
